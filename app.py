...
chat_completion_text = (
    "Exclude the 'Other' topic from the following dataset and then rank the percentages for each topic in descending order. Keep this ranking in mind but don't bullet point it. Instead just take the top four from this ranked list and summarise the top 4 topics in two sentences, "
